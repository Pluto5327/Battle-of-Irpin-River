...
to setup
  ...
  set grass-color approximate-rgb 124 220 132
  set main-road-color approximate-rgb 0 0 0
  set rural-road-color approximate-rgb 104 110 106
...
to classify-terrain
  ask patches [
    if pcolor = grass-color [ set terrain "grass" ]
    if pcolor = main-road-color [ set terrain "main-road" ]
    if pcolor = rural-road-color [ set terrain "rural-road" ]
